...
def execute(self, context, target_size, cubey_axis, joinSelected):
    print("axis =", cubey_axis)
    ...
    def getDimention():
        ...
        return butils.getFinalCubeyDimentions(active_obj_eval, cube_width)[cubey_axis]
